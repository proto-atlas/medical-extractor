...
Lighthouse CLIは計測JSON作成後、Windows Temp内のprofile teardownで `EPERM` を返してexit 1 になった。JSONは生成済みで、上記スコアはJSONから抽出した値。

2026-04-27 の [`lighthouse-2026-04-27.md`](./lighthouse-2026-04-27.md) は、Windows + Playwright Chromiumで正式スコアが取得できなかった経緯の記録として残す。
