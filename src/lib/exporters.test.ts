...
describe('formatJson', () => {
  it('SOAPデータを 2 スペースインデントのJSON文字列に整形する', () => {
...
describe('formatCsv', () => {
  ...
  it('S/O/A/P順で 4 行のデータ行が出力される (合計 5 行)', () => {
    const csv = formatCsv(sampleSOAP);
    const lines = csv.split('\n');
